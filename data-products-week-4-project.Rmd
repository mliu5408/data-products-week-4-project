...
## Application Development
 ...
 - The web application is named ***MPGPrediction***. An instance is up & running at [MPG Prediction](https://mliu5408.shinyapps.io/MPGPrediction/).
 ...
 - The web application and the current presentation source codes can be found at <https://github.com/mliu5408/data-products-week-4-project>. The web application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *modelBuilding.R* (Random Forest predictor) under the folder ***source***. The R Markdown code of this presentation is named data-products-week-4-project.Rmd and the presentation is published on http://rpubs.com/mliu5408/403473. A README.md file in Markdown format is also stored in the same github location.
