...
## Application Development
 ...
 - All files of this assignment are stored at https://github.com/mliu5408/data-products-week-4-project/. The web application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *modelBuilding.R* (Random Forest predictor) under the folder ***source***. The R Markdown code of this presentation is named data-products-week-4-project.Rmd and the presentation is published on http://rpubs.com/mliu5408/403473. A README.md file in Markdown format is also stored in the same github location.
